                            ...
                            <div className="card-body p-5">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter name" name="pestName" value={pesticides.pestName} onChange={changeHandle} required/>
                                    </div>

                                    <div className="form-group">
                                        <label >Available Quantity:</label>
                                        <input type="number" className="form-control" placeholder="Enter Available quantity" name="avlQtyInGm" min="0" value={pesticides.avlQtyInGm} onChange={changeHandle} required/>
                                    </div>

                                    <div className="form-group">
                                        <label >Price per Quantity:</label>
                                        <input type="number" step="0.01" className="form-control" placeholder="Enter price per quantity" min="0" name="pricePerGm" value={pesticides.pricePerGm} onChange={changeHandle} required/>
                                    </div>
