...
function WarehouseOperatorChangePassword(props) {
    ...
    const handleSubmit = (e) => {
        ...
        if(newPassword === confirmPassword){
            if(oldPassword === confirmPassword){
                ...
                WarehouseOperatorService.changePassword(objects.operatorEmail,oldPassword,confirmPassword)
                .then((response)=>{
                  SetSuccess(true)
                  SetFailure(false)
                })
...
export default WarehouseOperatorChangePassword