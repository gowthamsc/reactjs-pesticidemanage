...
function DiseaseRegister(props) {
    ...
    const handleSubmit = async (event) => {
        ...
        if(size > 1) {
            ...
            await axios({
                method: 'post',
                url: 'https://pest-manage-banckend.herokuapp.com/disease/add',
                data: formData,
                            ...
                            <div className="card-body p-5">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-group mb-2">
                                        ...
                                        <input type="number" className="form-control" placeholder="Enter acre" value={acre} name="acre" min="1" onChange={(e) => setAcre(e.target.value)} required/>
                                    </div>
                                    <div className="form-group mb-2">
